...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I'm an OutSystems Low-Code Developer and Full-Stack Developer based in the Philippines. I am highly passionate and dedicated to my work.</p>
